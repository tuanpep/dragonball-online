        ...
        <Container maxW={'3xl'}>
          ...
          >
            <Heading
              ...
              color={'white'}
            >
              <p className="font-extrabold text-amber-300 drop-shadow-lg ">Ngọc Rồng Online</p>
            </Heading>
            <p className="font-bold mt-2 text-white drop-shadow-lg shadow-black md:text-4xl sm:2xl">
